...
class Cart(TimeStampedModel):
    ...
    def __str__(self):
        return f"{self.user.phone_number} cart"
...
class Order(TimeStampedModel):
    ...
    def __str__(self):
        return f"{self.user.phone_number} order"
...
class Review(TimeStampedModel):
    ...
    class Meta:
        """ user ham product unikal boliwi taminleydi: sol product ushin bir marte Review qaldira aladi """
        unique_together = (
            "user",
            "product",
        )
    ...
    def __str__(self):
        return f"{self.user.phone_number}'s rating for {self.product.name}: {self.rating}"
