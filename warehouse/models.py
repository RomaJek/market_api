...
class Product(TimeStampedModel):
    ...
    # slug da blank=True swagerde validatsiyadan otiw ushin jazildi. blank - pustoy bolip keliwge ruxsat
    # API ushin slug avtomat jaratiladi
    slug = models.SlugField(unique=True, blank=True, verbose_name="product URL slug")
    ...
    discount_price = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=Decimal('0.00'),    # Decimal- putin sanlardin aniqligi ushin. misal 0.0002 bul pul esap sanaq aniq boliwi ushin
    ...
    def save(self, *args, **kwargs):
        # eger slug pustoy kelse name-nan alip avtomat jaratadi
        if not self.slug:
