...
""" Swager Ui insterfeysi ushin qalib waziypasin atqaradi """
# aniq Haqiqiy serializerler emes tek gana Swagger deneshi ushin qalip 

# Bul narse frontend ushun standart juwap qaytariwga qolay.
def wrapped_response(data_serializer, many=False):
    """ Qalegen Serializerdi alip birdey standart qalipke orap beredi """
...
class MessageResponseSerializer(serializers.Serializer):
    ...
    error = serializers.JSONField(allow_null=True, default=False)
